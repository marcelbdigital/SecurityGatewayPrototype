...
public abstract class EntitlementCallbackHandler {
    ...
    public String getCloud4allToken(MessageContext synCtx) 
    {
    	System.out.println("ENTREM A getCloud4allToken");
        Axis2MessageContext axis2Msgcontext = null;
        org.apache.axis2.context.MessageContext msgContext;
        axis2Msgcontext = (Axis2MessageContext) synCtx;
        msgContext = axis2Msgcontext.getAxis2MessageContext(); 
        return (String) axis2Msgcontext.getProperty("token");
    }
    
    public String getCloud4allIDApp(MessageContext synCtx) 
    {
    	System.out.println("ENTREM A getCloud4allIDApp");
        Axis2MessageContext axis2Msgcontext = null;
        org.apache.axis2.context.MessageContext msgContext;
        axis2Msgcontext = (Axis2MessageContext) synCtx;
        msgContext = axis2Msgcontext.getAxis2MessageContext(); 
        return (String) axis2Msgcontext.getProperty("idapp");
    }
    
    public String getCloud4allIP(MessageContext synCtx) 
    {
    	System.out.println("ENTREM A getCloud4allIDApp");
        Axis2MessageContext axis2Msgcontext = null;
        org.apache.axis2.context.MessageContext msgContext;
        axis2Msgcontext = (Axis2MessageContext) synCtx;
        msgContext = axis2Msgcontext.getAxis2MessageContext(); 
        return (String) axis2Msgcontext.getProperty("IP");
    }
    ...
    /**
     * Returns environment properties in an array of Strings. The default implementation returns
     * null.
     * 
     * @param synCtx
     * @return
