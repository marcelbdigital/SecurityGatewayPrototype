...
import org.wso2.carbon.mediator.bam.ui.DdlAjaxProcessorHelper;
    ...
    if(ddlAjaxProcessorHelper.isNotNullOrEmpty(action)){
        if(action.equals("getServerProfiles") && ddlAjaxProcessorHelper.isNotNullOrEmpty(serverProfilePath)){
            ...
            out.write(responseText);
                   ...
                   ddlAjaxProcessorHelper.isNotNullOrEmpty(serverProfilePath) &&
                   ddlAjaxProcessorHelper.isNotNullOrEmpty(streamName)){
            responseText = ddlAjaxProcessorHelper.getVersionListForStreamName(serverProfilePath, streamName);
            out.write(responseText);
        } else {
            out.write(0);
        }
