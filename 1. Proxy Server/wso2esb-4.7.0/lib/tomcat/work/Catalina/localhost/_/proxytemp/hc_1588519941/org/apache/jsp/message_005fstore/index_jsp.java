...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      _jspx_th_fmt_bundle_0.setBasename("org.wso2.carbon.message.store.ui.i18n.Resources");
      ...
      if (_jspx_eval_fmt_bundle_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          ...
          _jspx_th_carbon_jsi18n_0.setResourceBundle("org.wso2.carbon.message.store.ui.i18n.Resources");
          ...
          _jspx_th_carbon_breadcrumb_0.setLabel("Message Stores");
          _jspx_th_carbon_breadcrumb_0.setResourceBundle("org.wso2.carbon.message.store.ui.i18n.Resources");
          ...
          out.write("        var content = cell.firstChild.innerHTML;\n");
          out.write("\n");
          out.write("        function delEp() {\n");
          out.write("            document.location.href = \"deleteMessageStoresHandler.jsp?\" + \"messageStoreName=\" + content;\n");
          out.write("        }\n");
          out.write("\n");
          ...
          out.write("    }\n");
          out.write("\n");
          out.write("    function editRow(i, storeType) {\n");
          out.write("        var table = document.getElementById(\"myTable\");\n");
          out.write("        var row = table.rows[i];\n");
          out.write("        var cell = row.cells[0];\n");
          out.write("        var type = row.cells[1];\n");
          out.write("        var content = cell.firstChild.innerHTML;\n");
          out.write("        if (storeType == \"org.wso2.carbon.message.store.persistence.jms.JMSMessageStore\") {\n");
          out.write("            document.location.href = \"jmsMessageStore.jsp?\" + \"messageStoreName=\" + content;\n");
          out.write("        } else if (storeType == \"org.apache.synapse.message.store.InMemoryMessageStore\") {\n");
          out.write("            document.location.href = \"inMemoryMessageStore.jsp?\" + \"messageStoreName=\" + content;\n");
          out.write("        } else {\n");
          out.write("            document.location.href = \"customMessageStore.jsp?\" + \"messageStoreName=\" + content;\n");
          out.write("        }\n");
          out.write("    }\n");
          out.write("\n");
          ...
          if (_jspx_meth_fmt_message_2((javax.servlet.jsp.tagext.JspTag) _jspx_th_fmt_bundle_0, _jspx_page_context))
            return;
          out.write("', function() {\n");
          out.write("            document.location.href = \"deleteMessageStoresHandler.jsp?\" + \"entryName=\" + entry + \"&force=true\";\n");
          out.write("        });\n");
          out.write("    }\n");
          out.write("\n");
          out.write("</script>\n");
...
if (messageStoreNames != null) {
          ...
          out.write("\n");
          out.write("                    <tr>\n");
          out.write("                        <td><a href=\"viewMessageStore.jsp?messageStoreName=");
          out.print(name);
          out.write('"');
          out.write('>');
          out.print(name);
...
if (!type.trim().equals("org.wso2.carbon.message.store.persistence.jms.JMSMessageStore")) { 
          ...
          out.write("                        <td>\n");
          out.write("                            <a onclick=\"");
          out.print(("org.apache.synapse.message.store.InMemoryMessageStore".equals(type.trim()))?"return false":"editRow(this.parentNode.parentNode.rowIndex,"+"'" + type + "');");
          out.write("\"\n");
          out.write("                               class=\"");
          out.print(("org.apache.synapse.message.store.InMemoryMessageStore".equals(type.trim()))?"icon-link-disabled":"icon-link");
          out.write("\"\n");
  ...
  private boolean _jspx_meth_fmt_message_0(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_0.setKey("do.you.want.to.delete.the.message.store");
  ...
  private boolean _jspx_meth_fmt_message_3(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_3.setKey("manage.message.stores");
  ...
  private boolean _jspx_meth_fmt_message_4(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_4.setKey("available.messageStores.tab.title");
  ...
  private boolean _jspx_meth_fmt_message_5(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_5.setKey("add.messageStores.tab.title");
  ...
  private boolean _jspx_meth_fmt_message_6(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_6.setKey("no.messageStores.are.currently.defined");
  ...
  private boolean _jspx_meth_fmt_message_7(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_7.setKey("messageStore.name");
  ...
  private boolean _jspx_meth_fmt_message_9(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_9.setKey("size");
  ...
  private boolean _jspx_meth_fmt_message_13(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_13.setKey("add.messageStore.title");
  ...
  private boolean _jspx_meth_fmt_message_14(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_14.setKey("in.memory.message.store");
  ...
  private boolean _jspx_meth_fmt_message_15(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_15.setKey("in.memory.message.store.desc");
  ...
  private boolean _jspx_meth_fmt_message_16(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_16.setKey("jms.message.store");
  ...
  private boolean _jspx_meth_fmt_message_17(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_17.setKey("jms.message.store.desc");
  ...
  private boolean _jspx_meth_fmt_message_18(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_18.setKey("custom.message.store");
  ...
  private boolean _jspx_meth_fmt_message_19(javax.servlet.jsp.tagext.JspTag _jspx_th_fmt_bundle_0, PageContext _jspx_page_context)
    ...
    _jspx_th_fmt_message_19.setKey("custom.message.store.desc");
